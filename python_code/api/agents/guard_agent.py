...
class GuardAgent():
    def __init__(self):
        # Pas besoin de client OpenAI ici
        pass
    ...
    def get_response(self, messages):
        ...
        # Utilisez la fonction importée de utils.py
    ...
    def postprocess(self, output):
        ...
        try:
            ...
            parsed_output = {
                "chain of thought": "Invalid response format",
        ...
        dict_output = {
            ...
            "memory": {
                "agent": "guard_agent",
                "guard_decision": parsed_output.get('decision', 'not allowed')
            }
        }
        return dict_output